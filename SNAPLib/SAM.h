...
public:
    ...
    static void computeCigar(CigarFormat cigarFormat, const Genome * genome, LandauVishkinWithCigar * lv,
        ...
        const BaseRef * data, GenomeDistance dataLength, unsigned basesClippedBefore, GenomeDistance extraBasesClippedBefore, unsigned basesClippedAfter,
...
#else	// DEBUG
	inline static void validateCigarString(const Genome *genome, const char * cigarBuf, int cigarBufLen, const BaseRef *data, GenomeDistance dataLength, GenomeLocation genomeLocation, Direction direction, bool useM) {}
#endif // DEBUG
